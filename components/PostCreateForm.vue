...
export default {
  ...
  data() {
    return {
      ...
      info: '', 
      price: '', 
      image: 'https://placeimg.com/400/600/fashion',
      categorys: [
  ...
  methods: {
    onSubmit() {
      ...
      const { name, info, price, image, category, subCategory, sellerId, area, date, options, reviews} = this
      const post = { name, info, price, image, category, subCategory, sellerId, area, date, options, reviews}
      console.log(post)
